...
# prod id = 7523
# prod test id = 15749
# old prod test id = 15033
# local id = 10960
#Admin Domain Stage
admin_domain_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.ID, "navmenu-15749-href")))
admin_domain_button.click()
    
admin_domain_groups_link = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.ID, "navmenu-15749-groups-href")))
