...
# local id = 10960
#Admin Domain Stage
admin_domain_button = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.ID, "navmenu-7523-href")))
admin_domain_button.click()
    
admin_domain_groups_link = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.ID, "navmenu-7523-groups-href")))
